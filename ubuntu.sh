...
if [ $1 == "-u" ];then
    ...
    clear; echo -e "${cy}Sucessfully Installed.\n\n${rd}Type ${cy}./ubuntu -i${rd} to launch the script\n\n"


elif [ $1 == "-i" ];then
    clear; start; banner; social; proot-distro install ubuntu; clear; echo -e "${rd}Type ${cy}./ubuntu -l ${rd}to login in ubuntu";

elif [ $1 == "-r" ];then
    proot-distro remove ubuntu; clear

elif [ $1 == "-l" ];then
    clear; proot-distro login ubuntu
